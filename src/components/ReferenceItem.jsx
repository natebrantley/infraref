        ...
        <div style={{ marginTop: "6px", fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", color: "#94a3b8", lineHeight: 1.6 }}>
          ...
          {hasDetailPage ? (
            <button
              ...
              style={{ marginLeft: "12px", color: "#f97316", fontSize: "10px", background: "none", border: "none", cursor: "pointer", padding: 0, fontFamily: "inherit" }}
            ...
            <a
              ...
              style={{ marginLeft: "12px", color: "#f97316", fontSize: "10px", textDecoration: "none" }}
            >→ Open Resource ↗</a>
          ) : (
            <span style={{ marginLeft: "12px", color: "#64748b", fontSize: "10px" }}>→ Link TBD</span>
          )}
        </div>
      )}
    </div>
